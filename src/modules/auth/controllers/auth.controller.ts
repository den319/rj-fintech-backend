...
export const logoutController= asyncHandler(
    async (req: Request, res:Response) => {
        ...
        if(!userId) {
            return res.status(HTTP_STATUS.UNAUTHORIZED).json({ message: "Unauthorized user! Cannot log-out." }); 
        }
...
export const refreshTokenController = asyncHandler(
    ...
    return setJwtAuthCookie({ res, accessToken: newAccessToken, refreshToken: newRefreshToken }).status(HTTP_STATUS.OK).json({
